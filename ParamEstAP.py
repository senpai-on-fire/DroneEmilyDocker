...
class HarData:
    ...
    def __init__(self,seq_len=16):
        ...
        train_x = np.loadtxt(f"data/har/UCI HAR Dataset/train/Train_559_{numID}_glucose.txt")
        train_y = (np.loadtxt(f"data/har/UCI HAR Dataset/train/Train_559_{numID}_glucose.txt")-1)#.astype(np.int32)
        train_ins = np.loadtxt(f"data/har/UCI HAR Dataset/train/Train_559_{numID}_bolus.txt")
        train_meal = np.loadtxt(f"data/har/UCI HAR Dataset/train/Train_559_{numID}_meal.txt")
        train_basal = np.loadtxt(f"data/har/UCI HAR Dataset/train/Train_559_{numID}_basal.txt")
        train_initIsc1 = np.loadtxt(f"data/har/UCI HAR Dataset/train/Train_559_{numID}_Isc1.txt")
        train_initIsc2 = np.loadtxt(f"data/har/UCI HAR Dataset/train/Train_559_{numID}_Isc2.txt")
        train_initIp = np.loadtxt(f"data/har/UCI HAR Dataset/train/Train_559_{numID}_Ip.txt")
        train_BW = np.loadtxt(f"data/har/UCI HAR Dataset/train/Train_559_{numID}_BW.txt")
        train_u2ss = np.loadtxt(f"data/har/UCI HAR Dataset/train/Train_559_{numID}_u2ss.txt")
        ...
        test_x = np.loadtxt(f"data/har/UCI HAR Dataset/test/Train_559_{numID}_glucose.txt")
        test_y = (np.loadtxt(f"data/har/UCI HAR Dataset/test/Train_559_{numID}_glucose.txt")-1)#.astype(np.int32)
        test_ins = np.loadtxt(f"data/har/UCI HAR Dataset/test/Train_559_{numID}_bolus.txt")
        test_meal = np.loadtxt(f"data/har/UCI HAR Dataset/test/Train_559_{numID}_meal.txt")
        test_meal2 = test_meal
        test_basal = np.loadtxt(f"data/har/UCI HAR Dataset/test/Train_559_{numID}_basal.txt")
        test_initIsc1 = np.loadtxt(f"data/har/UCI HAR Dataset/test/Train_559_{numID}_Isc1.txt")
        test_initIsc2 = np.loadtxt(f"data/har/UCI HAR Dataset/test/Train_559_{numID}_Isc2.txt")
        test_initIp = np.loadtxt(f"data/har/UCI HAR Dataset/test/Train_559_{numID}_Ip.txt")
        test_BW = np.loadtxt(f"data/har/UCI HAR Dataset/test/Train_559_{numID}_BW.txt")
        test_u2ss = np.loadtxt(f"data/har/UCI HAR Dataset/test/Train_559_{numID}_u2ss.txt")
    ...
    def fit(self,gesture_data,epochs,verbose=True,log_period=50):
        ...
        for e in range(epochs):
            ...
            if best_loss > newLoss :
                ...
                if count > 10:
                    break
            if np.abs(best_loss - newLoss) < 0.05*best_loss :
                count2 = count2 + 1
            else:
                count2 = 0
            if count2 > 3 :
        ...
        columns = ['test_loss' 'kempt', 'kabs', 'Gb', 'SG', 'p2', 'SI', 'kd', 'ka2']
        values = [test_loss, kempt, kabs, Gb, SG, p2, SI, kd, ka2]  # Replace with your float values
