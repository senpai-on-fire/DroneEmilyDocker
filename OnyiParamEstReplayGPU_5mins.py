...
class HarData:
    ...
    def iterate_train(self,batch_size=2):
...
class HarModel:
    ...
    def fit(self,gesture_data,epochs,verbose=True,log_period=50):
        ...
        for e in range(epochs):
            ...
            #breakpoint()
            for batch_x,batch_y,batch_ins,batch_mL,batch_basal,batch_initIsc1,batch_initIsc2,batch_initIp,batch_BW,batch_u2ss in gesture_data.iterate_train(batch_size=2):
